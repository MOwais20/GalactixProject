...
var library_min_js_1 = require("./charting_library.js");
...
var DataFeed = /** @class */ (function () {
    ...
    DataFeed.prototype.getBars = function (symbolInfo, resolution, from, to, onHistoryCallback, onErrorCallback, firstDataRequest) {
        ...
        getBars({ symbolInfo: symbolInfo, resolution: resolution, from: from, to: to, firstDataRequest: firstDataRequest, onHistoryCallback: onHistoryCallback, onErrorCallback: onErrorCallback, contextChart: _this });
    };
    /**
